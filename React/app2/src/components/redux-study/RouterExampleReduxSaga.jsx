 ...
 * @Last Modified time: 2020-03-21 21:50:30
 */
...
import { asyncLogin } from '../../store/user.redux.saga.js'
...
const Login = connect(
  ...
  { asyncLogin }
)(function Login({ location, isLogin, asyncLogin, loading, error }) {
  ...
  return (
    <div>
      ...
      />
      <hr />
      <Button onClick={() => asyncLogin(uname)} disabled={loading}>
        {loading ? '登录中...' : '登录'}
      </Button>
    </div>
  )
